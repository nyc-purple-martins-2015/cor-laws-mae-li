...
describe 'Card' do
 let(:new_card) { Card.new(question: "Are we human or are we dancers?", answer: "Yes")}

   describe '#question' do
     it 'card.question should be initialized with a string' do
      expect(new_card.question).to eq("Are we human or are we dancers?")
     end
  end

  describe '#answer' do
    it 'card.answer should be initialized with a string' do
      expect(new_card.question).to be_a(String)
    end
  end
end
